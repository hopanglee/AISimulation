...
public class iPhone : Item, IUsable
{
    ...
    private static List<ChatMessage> BuildHinoIzumiInitialConversation()
    {
        ...
        list.Add(new ChatMessage("2025-07-03 15:24:02", "와타야", "카페는 네 편이야. 네가 좋은 자리 **찜**하고! 걔는 구석에 앉히자. 🤫"));
        ...
        list.Add(new ChatMessage("2025-07-10 19:10:27", "히노", "가끔 그 사람의 **과한 친절**이 부담이야… 미안. 🥺"));
    ...
    private static List<ChatMessage> BuildHinoKamiyaInitialConversation()
    {
        ...
        list.Add(new ChatMessage("2025-06-10 08:09:01", "히노", "오늘은 **긍정적**으로! 웃는 얼굴로 인사할게 😎"));
        list.Add(new ChatMessage("2025-06-10 20:41:50", "히노", "오늘 **노트에 그림** 그렸어. **절차 기억**이 생기기를 🙏 내일 브루랩 괜찮아?"));
        ...
        // 7/7 방학 중 약속 재확인
        list.Add(new ChatMessage("2025-07-07 16:05:00", "히노", "방학 중에도 매일 만날 수 있는 거지? 약속! **확신**이 필요해."));
        ...
        list.Add(new ChatMessage("2025-07-14 20:05:12", "히노", "좋아! **성실함**이 나를 지킬 거야 ✅ 내일 브루랩 15:00."));

        // 7/19 루틴 & 안정감
        list.Add(new ChatMessage("2025-07-19 15:03:10", "카미야", "조금 쉬어가자. 네 호흡이 빠른 것 같아서."));
        list.Add(new ChatMessage("2025-07-19 15:03:58", "히노", "응, 잠깐 멈춤. 고마워. 네 **차분함**이 나를 진정시켜. 내일 모카하우스 14:00."));
