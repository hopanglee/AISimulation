...
public class iPhone : Item, IUsable
{
    ...
    private static List<ChatMessage> BuildHinoIzumiInitialConversation()
    {
        ...
        list.Add(new ChatMessage("2025-06-10 19:20:05", "와타야", "오늘은 어땠어? 네가 편하면, 그냥 듣기만 할게. 😌"));
        list.Add(new ChatMessage("2025-06-10 19:21:40", "히노", "괜찮았어. 조용해서 마음이 덜 흔들렸어. 🧘‍♀️"));
        list.Add(new ChatMessage("2025-06-10 19:23:12", "와타야", "그 사람(카미야)…너한테 부담 주진 않지? 널 지키는 게 먼저야. 솔직히 걔 표정관리 좀 하는 거 같더라? 🤨"));
        list.Add(new ChatMessage("2025-06-12 21:18:42", "와타야", "울컥할 땐 말 안 해도 돼. 내가 옆에 있을게. 걍 나한테 다 풀자. 😡"));
        list.Add(new ChatMessage("2025-06-12 21:20:00", "히노", "고마워. 네 말 들으면 덜 불안해. 💖"));
        list.Add(new ChatMessage("2025-06-14 18:07:00", "와타야", "야, 그 사람! 좋은 척하는데 지 맘대로 무리할 때 있더라. 네 리듬이 먼저야. 걔 말고."));
        list.Add(new ChatMessage("2025-06-16 09:12:10", "히노", "오늘은 내가 먼저 인사해볼까 해. 두근두근. 😊"));
        list.Add(new ChatMessage("2025-06-16 09:13:22", "와타야", "오 멋지다! 네 속도대로! 누가 방해하면 내가 먼저 눈치 백만 개 줄게. 😤"));
        list.Add(new ChatMessage("2025-06-20 17:31:45", "히노", "약속 세 개(장소/시간/좌석) 적어뒀어. 조금 덜 무서워. 📝"));
        list.Add(new ChatMessage("2025-06-20 17:33:01", "와타야", "좋아. 그리고… 네가 피곤하면 걍 튀어나와도 돼. 약속이 뭐 대수냐. 너 재촉하는 애들이 나쁜 거지. 😤"));
        list.Add(new ChatMessage("2025-06-22 20:03:30", "히노", "오늘은 침묵이 덜 어색했어. 😶"));
        list.Add(new ChatMessage("2025-06-22 20:04:12", "와타야", "걔 침묵 연기 잘하더라. 네 마음이 먼저야. 불편하면 바로 나한테 말해. 😠"));
        list.Add(new ChatMessage("2025-06-24 16:11:50", "히노", "…조금 충격적이었어. 오늘. 😔"));
        list.Add(new ChatMessage("2025-06-24 16:12:33", "와타야", "에이. 괜찮아. 네게 해로운 건 기록도 하지 마. 네가 흔들리면 내가 멱살 잡고 잡아줄게! 🔥"));
        list.Add(new ChatMessage("2025-06-28 19:40:25", "히노", "오늘 ‘토오루 군’이라고 말해봤어. 기분 이상했어. 😅"));
        list.Add(new ChatMessage("2025-06-28 19:41:10", "와타야", "헐? 😲 네가 편하면 해. 근데 그 말이 너 상처 주면 그냥 '야'라고 불러! 상관없어."));
        list.Add(new ChatMessage("2025-07-01 08:10:03", "히노", "오늘 문장: 같은 자리 오래 있기. ✏️"));
        list.Add(new ChatMessage("2025-07-01 08:11:18", "와타야", "좋아. 자리를 지키는 건 마음 지키는 거기도 하지. 쓸데없이 딴 데 가지 마."));
        list.Add(new ChatMessage("2025-07-03 15:22:41", "히노", "브루랩에서 읽은 문장들… 좀 편했어. ☕️"));
        list.Add(new ChatMessage("2025-07-03 15:24:02", "와타야", "카페는 네 편이야. 네가 좋은 자리 찜하고! 걔는 구석에 앉히자. 🤫"));
        list.Add(new ChatMessage("2025-07-07 16:35:12", "히노", "방학에도 매일… 할 수 있을까? 😥"));
        list.Add(new ChatMessage("2025-07-07 16:36:09", "와타야", "야, 너무 힘들면 뻥치고 쉬어. 약속은 너 지키는 도구지 걔 지키는 게 아니잖아. 😡"));
        list.Add(new ChatMessage("2025-07-10 19:10:27", "히노", "가끔 그 사람의 과한 친절이 부담이야… 미안. 🥺"));
        list.Add(new ChatMessage("2025-07-10 19:11:35", "와타야", "뭐? 미안할 일 아니거든! 네가 불편하면 걔가 과한 거야. 적당히 선 넘지 말라고 해. 🔪"));
        list.Add(new ChatMessage("2025-07-12 09:31:05", "히노", "오늘은 집에서 쉬고 싶어. 노트만 조금. 🛌"));
        list.Add(new ChatMessage("2025-07-12 09:31:59", "와타야", "당연히 쉬어야지! 나 오늘 너네 집 갈까? 걔한테는 비밀. 🍿"));
        list.Add(new ChatMessage("2025-07-14 15:04:12", "히노", "나… 노트를 사용한다고 그에게 말했어. 🗣️"));
        list.Add(new ChatMessage("2025-07-14 15:05:20", "와타야", "잘했어! 네 방식이 제일 중요해. 걔가 그걸 존중 못하면 걔가 나쁜 놈이지 뭐. 😤"));
        list.Add(new ChatMessage("2025-07-16 21:15:40", "히노", "그림이 늘어. 손이 기억하는 느낌이야. ✨"));
        list.Add(new ChatMessage("2025-07-16 21:16:31", "와타야", "역시! 그림은 네 편이지. 사람보다 습관이 너를 지키게 하자. 👏"));
        list.Add(new ChatMessage("2025-07-18 18:40:10", "히노", "오늘은 우리 집에서 조용히 있었어. 마음이 덜 요동쳤어. 🏠"));
        list.Add(new ChatMessage("2025-07-18 18:41:02", "와타야", "그게 답일 때도 많아. 걔랑 밖에서 힘 빼지 말고. ‘조용함’은 네 친구야. 🤫"));
        list.Add(new ChatMessage("2025-07-19 15:20:24", "히노", "호흡 빠를 때 잠깐 멈추자고 해줘서 괜찮았어. 🌬️"));
        list.Add(new ChatMessage("2025-07-19 15:21:11", "와타야", "좋아. 근데 네가 원치 않으면 '잠깐'이 아니라 '영원히' 멈춰도 돼. 😌"));
        list.Add(new ChatMessage("2025-07-20 18:05:49", "히노", "노트 속 선이 더 섬세해졌대. 그 말이 좋았어. 🤩"));
        list.Add(new ChatMessage("2025-07-20 18:06:33", "와타야", "섬세함 = 너의 힘. 네가 네 자신을 믿어도 돼. 걔 칭찬에 흔들리지 말고. 😉"));
        list.Add(new ChatMessage("2025-07-21 19:12:00", "히노", "요즘은 불안이 조금 덜해. 너 때문일 거야. 🥰"));
        list.Add(new ChatMessage("2025-07-21 19:12:35", "와타야", "난 늘 네 편! 누군가 네 마음 흔들면 내가 먼저 걔한테 눈치 줄게. 😈"));
        list.Add(new ChatMessage("2025-07-22 21:09:31", "히노", "오늘은 안 울었어. 내일은 우리 집에서 16:00. 🥳"));
        list.Add(new ChatMessage("2025-07-22 21:10:12", "와타야", "잘했다! 내일은 네가 제일 편한 공간에서 시작하자. 절대 무리하지 마."));
        list.Add(new ChatMessage("2025-07-23 10:05:55", "히노", "아침은 좀 차분해. 오늘도 선 3개만 그릴게. 🎨"));
        list.Add(new ChatMessage("2025-07-23 10:06:40", "와타야", "좋아. 선 3개가 마음 3개를 지켜줄 거야. 저녁에 나한테 먼저 연락해. 내가 기다릴게. 📞"));
        return list;
    }
    ...
    private static List<ChatMessage> BuildKamiyaIzumiInitialConversation()
    {
        ...
        list.Add(new ChatMessage("2025-06-28 08:20:15", "와타야", "걔가 너 ‘토오루 군’이라고 불렀다며. 걔 말고 내가 널 그렇게 부를 때 어떤 기분일까? 🤫")); // 직접적인 경쟁 심리
        ...
        list.Add(new ChatMessage("2025-07-18 18:42:10", "와타야", "오늘 둘이 조용히 있었다며. 말 없는 너도 매력 있어. (호감 어필)"));
        ...
        list.Add(new ChatMessage("2025-07-22 21:08:21", "와타야", "내일은 걔 집이라며. 너무 오래 있다가 오지 마. 적당히 끝내. 🔪")); // 질투와 명령
        list.Add(new ChatMessage("2025-07-22 21:09:03", "카미야", "응."));
        list.Add(new ChatMessage("2025-07-23 10:07:12", "와타야", "오늘도 무리하지 말고. 필요하면 내가 바로 갈게. 밤에 연락 안 하면 내가 먼저 전화한다. 📞"));
        list.Add(new ChatMessage("2025-07-23 10:07:55", "카미야", "그래."));
        return list;
    }
    ...
    private static List<ChatMessage> BuildHinoKamiyaInitialConversation()
    {
        ...
        list.Add(new ChatMessage("2025-06-05 20:41:10", "히노", "나 히노 마오리. 오늘 일... 놀랐지? 번호 저장했어 😊 조건 잊지 마 ^^"));
        list.Add(new ChatMessage("2025-06-05 20:41:55", "카미야", "응. 카미야 토루. 저장했어. 내일 모카하우스 창가에서 보자."));
        list.Add(new ChatMessage("2025-06-05 20:44:03", "카미야", "내일 16:00, 창가. 짧게 답장해줘."));
        list.Add(new ChatMessage("2025-06-05 20:44:40", "히노", "✅"));

        // 6/6 아침(어색) / 저녁(끌림 시작)
        list.Add(new ChatMessage("2025-06-06 08:15:21", "히노", "어... 어제도 봤던가? 미안. 잘 기억이... 오늘도 모카하우스?"));
        list.Add(new ChatMessage("2025-06-06 08:16:02", "카미야", "응. 오늘은 15:30. 네가 편한 시간에 맞춰서 와."));
        list.Add(new ChatMessage("2025-06-06 20:11:40", "히노", "오늘 고개 끄덕이는 타이밍, 좋았어. 침묵이 충분했어. 내일도 부탁해."));

        // 6/7 카미야 질문 후 저녁 (병 고백 후, 대면 대화는 채팅 기록에 남기지 않음)
        list.Add(new ChatMessage("2025-06-07 18:35:40", "히노", "나 먼저 갈게. 부탁해."));
        list.Add(new ChatMessage("2025-06-07 18:37:01", "카미야", "응. 네가 원하는 대로 할게. 내일 처음처럼 다시 인사할게."));

        // 6/8 재시작 (매일의 루틴 시작)
        list.Add(new ChatMessage("2025-06-08 08:15:21", "히노", "어... 혹시 카미야 토루? 나 히노 마오리야. 잘 부탁해."));
        list.Add(new ChatMessage("2025-06-08 20:11:40", "히노", "오늘은 덜 불안했어! 네 차분함이 좋았어. 내일 16:00, 모카하우스?"));
        list.Add(new ChatMessage("2025-06-08 20:12:05", "카미야", "✅"));

        // 6/10 긍정적인 다짐 및 루틴 준수
        list.Add(new ChatMessage("2025-06-10 08:09:01", "히노", "오늘은 긍정적으로! 웃는 얼굴로 인사할게 😎"));
        list.Add(new ChatMessage("2025-06-10 20:41:50", "히노", "오늘 노트에 그림 그렸어. 절차 기억이 생기기를 🙏 내일 브루랩 괜찮아?"));
        list.Add(new ChatMessage("2025-06-10 20:42:15", "카미야", "응. 15:00. 조용한 자리."));

        // 6/12 눈물 후 위로
        list.Add(new ChatMessage("2025-06-12 20:18:42", "카미야", "사과할 일 아니야. 오늘은 문장 두 개만 붙잡자. 무리하지 말자."));
        list.Add(new ChatMessage("2025-06-12 20:20:00", "히노", "고마워 🙏 내일은 모카하우스 16:00."));

        // 6/14 절차 기억 이야기 (토오루가 주도)
        list.Add(new ChatMessage("2025-06-14 08:07:00", "카미야", "오늘 17:00 교실에서 보자. 그림 얘기 하자."));
        list.Add(new ChatMessage("2025-06-14 20:02:50", "히노", "오늘 고마워. 내 속도가 흔들릴 때 네가 묶어줘. 내일도 교실 17:00?"));
        list.Add(new ChatMessage("2025-06-14 20:03:15", "카미야", "✅"));

        // 6/16 노트 속 그림 감동
        list.Add(new ChatMessage("2025-06-16 08:05:40", "히노", "오늘은 내가 먼저 노트 펼친다! 시작은 내가 😎✍️"));
        list.Add(new ChatMessage("2025-06-16 21:10:12", "히노", "오늘 네가 웃은 순간, 나도 덜 무서웠어. 내일 모카하우스 15:00."));
        list.Add(new ChatMessage("2025-06-16 21:10:40", "카미야", "알겠어. 조용히 기다릴게."));

        // 6/20 약속 루틴 명확화
        list.Add(new ChatMessage("2025-06-20 11:02:31", "히노", "약속 장소... 나 또 헷갈린 것 같아. (노트를 보고도 혼동)"));
        list.Add(new ChatMessage("2025-06-20 11:03:05", "카미야", "괜찮아. 장소/시간/좌석 키워드 세 개로 적어두자."));
        list.Add(new ChatMessage("2025-06-20 11:05:12", "히노", "좋아! 적었어: 브루랩/14:00/창가 ✅"));

        // 6/22 히노의 긍정적인 평가
        list.Add(new ChatMessage("2025-06-22 08:03:19", "히노", "오늘은 덜 어색하네 ㅋㅋ 토오루 군, 너 성실한 학생 같아!"));
        list.Add(new ChatMessage("2025-06-22 20:12:45", "카미야", "낯섦과 익숙함이 같이 있는 게 우리가 견디는 방법 같아. 내일 교실 17:00."));
        list.Add(new ChatMessage("2025-06-22 20:13:02", "히노", "✅"));

        // 6/24 카미야의 2차 질문 → 히노의 연기 결의 (2차)
        list.Add(new ChatMessage("2025-06-24 14:01:10", "카미야", "[삭제됨]")); // 대면 대화로 시작하지만, 묻는 행위 자체는 채팅에 남김.
        list.Add(new ChatMessage("2025-06-24 15:40:05", "히노", "[삭제됨]"));
        list.Add(new ChatMessage("2025-06-24 15:41:12", "카미야", "응. 네가 원하는 대로 할게. 네가 편한 방식으로."));

        // 6/28 기적의 '토오루 군' 시도
        list.Add(new ChatMessage("2025-06-28 08:11:22", "히노", "어색... 카미야... 어... 토오루 군...?"));
        list.Add(new ChatMessage("2025-06-28 08:12:00", "카미야", "괜찮아. 내가 먼저 부를게. 히노."));
        list.Add(new ChatMessage("2025-06-28 19:33:10", "히노", "고마워! 네가 먼저 불러줘서 편했어 ^^ 이름은 초대장 같아. 내일 나카미세도리 15:00."));
        list.Add(new ChatMessage("2025-06-28 19:33:35", "카미야", "✅"));

        // 7/1 가짜 고백 명분 소멸 후
        list.Add(new ChatMessage("2025-07-01 08:06:19", "히노", "문장 하나만 추천해줘! 오늘 버티는 용으로 ㅎㅎ"));
        list.Add(new ChatMessage("2025-07-01 08:07:10", "카미야", "‘같은 자리에 오래 있기.’ 오늘의 문장."));
        list.Add(new ChatMessage("2025-07-01 20:41:50", "히노", "저녁엔 좀 편해진다. 내일 모카하우스 14:00."));

        // 7/7 방학 중 약속 재확인
        list.Add(new ChatMessage("2025-07-07 16:05:00", "히노", "방학 중에도 매일 만날 수 있는 거지? 약속! 확신이 필요해."));
        list.Add(new ChatMessage("2025-07-07 16:05:45", "카미야", "응. 매일 만날 거야. 변함없어. 약속할게."));
        list.Add(new ChatMessage("2025-07-07 20:41:50", "히노", "저녁엔 좀 편해진다 ㅎㅎ 내일 모카하우스 14:00."));

        // 7/14 노트 사용 자발적 고백
        list.Add(new ChatMessage("2025-07-14 15:02:31", "히노", "나, 사실 노트를 사용해. 매일의 나를 잊지 않으려고."));
        list.Add(new ChatMessage("2025-07-14 15:03:05", "카미야", "응. 기록하는 습관 멋지다. 나도 적어둘게: 노트/사용/기록"));
        list.Add(new ChatMessage("2025-07-14 20:05:12", "히노", "좋아! 성실함이 나를 지킬 거야 ✅ 내일 브루랩 15:00."));

        // 7/19 루틴 & 안정감
        list.Add(new ChatMessage("2025-07-19 15:03:10", "카미야", "조금 쉬어가자. 네 호흡이 빠른 것 같아서."));
        list.Add(new ChatMessage("2025-07-19 15:03:58", "히노", "응, 잠깐 멈춤. 고마워. 네 차분함이 나를 진정시켜. 내일 모카하우스 14:00."));

        // 7/22 마지막 채팅
        list.Add(new ChatMessage("2025-07-22 14:02:27", "히노", "오늘은 그냥 가만히 있어도 돼. 소음이 배경음처럼 들리는 날이야. (내적 불안)"));
        list.Add(new ChatMessage("2025-07-22 14:03:10", "카미야", "응, 알겠어. 천천히 하자."));
        list.Add(new ChatMessage("2025-07-22 21:14:33", "히노", "오늘은 안 울었어 ^^ 옆에 있어줘서 고마워. 내일 우리 집 거실 16:00."));

        // 7/23 최종 채팅 (아침/저녁, 장소: 모카하우스)
        list.Add(new ChatMessage("2025-07-23 20:39:00", "카미야", "내일은 모카하우스 16:00."));
        list.Add(new ChatMessage("2025-07-23 21:05:27", "히노", "고마워."));
