...
namespace Agent
{
    public class ObserveEnvironmentParameterAgent : ParameterAgentBase
    {
        private readonly string systemPrompt;
        private readonly ChatCompletionOptions options;
        private readonly GPT gpt;

        public ObserveEnvironmentParameterAgent(GPT gpt)
        {
            this.gpt = gpt;
            systemPrompt = "You are an ObserveEnvironment parameter generator.";
