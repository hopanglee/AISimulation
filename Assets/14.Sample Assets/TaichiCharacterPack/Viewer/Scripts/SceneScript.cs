    ...
    public class SceneScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (functionList["particle"])
            {
                ...
                particleList = txt.text.Split(
                    new string[] { "\r", "\n" },
                    StringSplitOptions.RemoveEmptyEntries
                );

                txt = Resources.Load<TextAsset>(
                    viewerSettingPath + "/" + ParticleAnimationListFile
                );
                particleAnimationList = txt.text.Split(
                    new string[] { "\r", "\n" },
                    StringSplitOptions.RemoveEmptyEntries
                );
            }
            ...
            animationCommonList = txt.text.Split(
                new string[] { "\r", "\n" },
                StringSplitOptions.RemoveEmptyEntries
            );
        ...
        void OnGUI()
        {
            ...
            string positionXText =
                "Position X : " + String.Format("{0:F1}", obj.transform.position.x);
            ...
            string positionYText =
                "Position Y : " + String.Format("{0:F1}", obj.transform.position.y);
            ...
            string positionZText =
                "Position Z : " + String.Format("{0:F1}", obj.transform.position.z);
        ...
        {
            SkinnedMeshRenderer renderer = GameObject
                .Find(curModelName + "_face")
                .GetComponent<SkinnedMeshRenderer>();
            var mesh = GameObject
                .Find(curModelName + "_face")
        ...
        Transform GetBone(GameObject _obj, string _bone)
        {
            SkinnedMeshRenderer SM =
                _obj.GetComponentInChildren(typeof(SkinnedMeshRenderer)) as SkinnedMeshRenderer;
            if (SM)
            {
